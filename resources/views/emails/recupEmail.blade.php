...
<body class="p-3" >
    <h4 class=" text-success  fs-4 mb-3">Recuperación de contraseña</h4>
    <div class="p-3">
        <p> Se ha generado una nueva contraseña de acceso: <span class= 'text-primary fw-bolder'>{{$details['password']}}</span>
            <br/>
            <br/>
            Ya puede acceder con su DNI/NIE y la contraseña generada.
        </p>
        <p>
