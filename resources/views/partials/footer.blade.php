<footer class="bg-dark text-success d-flex text-center mt-auto p-2">
    <img class="img-fluid align-self-center" src="{{asset('img/logo2Trans.png')}}" width ="60" alt="logo">
    <div class="d-md-flex justify-content-between w-100 ms-lg-4">
        <div class="text-md-end me-md-4 ">
            <p><i class="bi bi-house"></i> Nuestra dirección:   Calle&nbsp;de&nbsp;Jupiter&nbsp;10<br/>03501 Benidorm</p>
        </div>
        <div class="me-md-4"  >
